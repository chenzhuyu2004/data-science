...
class DARTS:
    def __init__(self, model, criterion, optimizer, scheduler, warmup_scheduler, device, history, accumulation_steps=1, patience=5, scheduler_type='default'):
        self.model = model
    ...
    def search(self, train_loader, val_loader, epochs=50, warmup_epochs=10):
        for epoch in range(epochs):
            ...
            self.writer.add_scalar('LearningRate', get_current_lr(self.optimizer), epoch)
